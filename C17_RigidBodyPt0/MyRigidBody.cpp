...
{ 
	...
	m_v3CenterG = m_m4ToWorld * vector4(m_v3CenterL, 1);
}
//Allocation
...
void MyRigidBody::AddToRenderList(void)
{
	...
	m_pMeshMngr->AddWireSphereToRenderList(glm::translate(m_m4ToWorld, m_v3CenterL) * glm::scale(IDENTITY_M4, vector3(m_fRadius)), m_v3Color);
	m_pMeshMngr->AddWireCubeToRenderList(glm::translate(m_m4ToWorld, m_v3CenterL) * glm::scale(m_v3HalfWidth), m_v3Color, RENDER_WIRE);
}
